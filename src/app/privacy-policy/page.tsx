...
const privacyPolicyQuery = `*[_type == "privacyPolicy" && _id == "privacyPolicy"][0]{
  title,
  slug,
  content,
  lastUpdated
...
export default async function PrivacyPolicyPage() {
  const legalDocument: LegalDocument | null = await client.fetch(privacyPolicyQuery)
      ...
      <main>
        <section className="legal-hero">
          ...
          <h1 className="hero-title-main">
            <span>{legalDocument?.title ?? 'Privacy Policy'}</span>
          </h1>
